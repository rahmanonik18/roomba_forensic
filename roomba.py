...
class IrobotAuthorization:
    ...
    def login(self):
        ...
        #print(app_id)
        data = {
            "app_id": "ANDROID-67815113-1C34-473E-B8F2-77BF1A444395",
...
def plot_map(points2d, borders, poses2d,typed_poses,objects):
    # Create figure and axes
     ...
     for obj in objects:
        ...
        obj_patch = mpatches.Polygon(obj_coords, facecolor='grey', edgecolor='black')
     ...
     handles=[arrow_legend, start_dot, end_dot]
     if doc_dot is not None:
         handles.append(doc_dot)

     handles.extend(object_legend)

     plt.legend(handles=handles, bbox_to_anchor=(1, 1), loc='upper right', fontsize='x-small')
...
#         ],
    ...
    pmap_id = list(first_dict['pmaps_robot'][0].keys())[0]
    pmapv_id = first_dict['pmaps_robot'][0][pmap_id]
...
def view_map(robotID, pmapID,pmapv):
    ...
    img = plot_map(points2d, borders, poses2d,typed_poses,objects)
